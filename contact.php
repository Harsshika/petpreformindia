...
<?php include "header.php"; ?>
    ...
    <main>
        ...
        <section class="df-contact__area section-spacing-top p-relative fix">
            ...
            <div class="row g-5 " style = "margin-top: 50px; margin-left: 20px; margin-right: 20px">
                    <div class="col-md col-md col-md">
                        <div class="df-contact__box wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <h4 class="df-contact__content"><a href="tel:+866332-2020">+9987150054</a></h4>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="df-contact__box wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <h4 class="df-contact__content"><a href="https://html.bdevs.net/cdn-cgi/l/email-protection#0c7f797c7c637e784c68636a6574226f6361"><span class="__cf_email__" data-cfemail="b0c3c5c0c0dfc2c4f0d4dfd6d9c89ed3dfdd">nashikpolymer@gmail.com</span></a>
                            </h4>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="df-contact__box wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <h4 class="df-contact__content"><a href="#">Shinde MIDC, Nashik 422102</a></h4>
                        </div>
                    </div>
                </div>
              <!-- Address Details End -->
